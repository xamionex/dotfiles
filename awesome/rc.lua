...
local function set_wallpaper(s)
	...
	if beautiful.wallpaper then
		...
		--Do not set wallpaper again if it's already set. Hits performance otherwise (might only be useful for fake_resize and stuff)
		if
...
local function random_wallpaper()
	local function set()
		...
		beautiful.wallpaper = wallpapers[idx]
		for s in screen do
			set_wallpaper(s)
		end
